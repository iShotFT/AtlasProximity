...
return [
    ...
    */
    ...
    'seo' => [
        'author'      => 'iShot',
        'description' => 'Atlas Discord Bot - Documentation',
        'keywords'    => 'atlas, playatlas, discord, bot, documentation, iShot',
        'og'          => [
            'title'       => 'Atlas Discord Bot - Documentation',
            'type'        => 'article',
            'url'         => '',
            'image'       => '',
            'description' => 'A fully automated Discord bot that can track players, boats and more on the official PvP NA and EU servers.',
        ],
    ],
