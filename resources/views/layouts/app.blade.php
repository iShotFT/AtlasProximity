...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta content="A discord bot that can handle boat alerts, player tracking, map generation, player listing and much more for the Wildcard Atlas game!" name="description"/>
        <meta content="iShot" name="author"/>
                ...
                <div class="header">
                    ...
                    <div class="">
                        <div class="brand inline">
                            <img alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" height="22" src="assets/img/logo.png" width="78">
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown pull-right d-lg-block d-none">
                            <button aria-expanded="false" aria-haspopup="true" class="profile-dropdown-toggle" data-toggle="dropdown" type="button">
                                <span class="thumbnail-wrapper d32 circular inline"><img alt="" data-src="assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg" height="32" src="assets/img/profiles/avatar.jpg" width="32"></span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                                <a class="dropdown-item m-0 pt-0" href="#">
                    ...
                    <div class="container-fluid container-fixed-lg footer">
                        <div class="copyright sm-text-center">
                            <p class="small no-margin pull-left sm-pull-reset">
                                ...
                                <span class="font-montserrat">iShot</span>
                                .
                        ...
                        <div class="view-port clearfix quickview-notes" id="note-views">
                            ...
                            <div class="view list" id="quick-note-list">
                                <div class="toolbar clearfix">
                                    <ul class="pull-right ">
                                        <li>
                                            <a href="#" class="delete-note-link">
                                                <i class="fa fa-trash-o"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="new-note-link" data-navigate="view" data-view-port="#note-views" data-view-animation="push">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </li>
                                    </ul>
                                    <button class="btn-remove-notes btn btn-xs btn-block hide">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <div class="p-l-10 inline p-t-5">
                                            <h5 class="m-b-5">
                                                <span class="semi-bold result-name">ice cream</span>
                                                on pages
                                            </h5>
